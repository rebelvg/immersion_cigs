if (!(isClass (configFile >> "CfgPatches" >> "ace_interact_menu"))) then {
    ...
    player addAction ["Take Cig from Pack", {[_this select 1] spawn murshun_cigs_fnc_take_cig_from_pack}, nil, 0, false, true, "", "'murshun_cigs_cigpack' in (magazineCargo uniformContainer player)", 5, false];
